...
at = airtable.Airtable('app6YqhGYmBkTw0Z9', 'key7rOEmhsnygjYJJ')

table = Table('key7rOEmhsnygjYJJ', 'app6YqhGYmBkTw0Z9', 'Table 2')
...
# print(examp)
  ...
  # ...'https://api.airtable.com/v0/app6YqhGYmBkTw0Z9/Table%201?maxRecords=3&view=Grid%20view', headers={'Authorization': 'keyFDgwgXZW5WWHXm'})
